...
function Footer() {
  return (
    <footer className=" mt-48 flex flex-col justify-between items-center xl:items-stretch w-full min-h-[60vh]  bg-gradient-to-b from-primary-600 to-primary-500 px-6 md:px-24 lg:px-48  pt-24 pb-24 gap-24 rounded-t-[3em] relative">
